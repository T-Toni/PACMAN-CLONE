...
class Botao:
    ...
    def __init__(self, x, y, largura, altura, imagem, tela, cor):
        ...
        if (imagem):
            ...
            self.imagem_invertida = pygame.transform.flip(pygame.image.load(imagem), True, False)
            self.imagem_invertida = pygame.transform.scale(self.imagem_invertida, (largura, altura))
        else:
            self.imagem = None
    ...
    def desenha(self):
        ...
        if not self.invertido:
            ...
            if self.imagem_invertida and self.largura >= self.largura_alternativa:
                self.tela.blit(self.imagem_invertida, (self.x, self.y))
